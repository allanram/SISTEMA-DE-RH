...
namespace iRh.Windows.Core
{
    public class Estados
    {
        ...
        public List<Estados> ObterTodosEstados()
        {
            ...
            listaDeEstados.Add(new Estados { Nome = "Rondonia", Sigla = "RO" });
            listaDeEstados.Add(new Estados { Nome = "Bahia ", Sigla = "BA" });
            listaDeEstados.Add(new Estados { Nome = "Espírito Santo ", Sigla = "ES" });
            ...
            listaDeEstados.Add(new Estados { Nome = "Goiaís", Sigla = "GO" });
